    ...
    <div className="mt-24">
      <div className="bg-[#2D2F31] text-white">
        ...
        <div className="max-w-7xl ml-auto py-8 md:px-8 flex flex-col gap-2 text-left">
          ...
          <p>
            Created By {""}{" "}
            <span className="text-[#C0C4FC] underline italic">Rafi Haq</span>
          </p>
      ...
      <div className="max-w-7xl mx-auto my-5 px-4 md:px-8 flex flex-col lg:flex-row justify-between gap-10">
        <div className="w-full lg:w-1/2 space-y-5">
          ...
          <p className="text-sm">
            ...
            perferendis fugiat nemo explicabo quis, consequatur quod cumque
            repellat enim et voluptates facere quos voluptas totam quia
            doloremque numquam? Quo, laborum!
          </p>
          <Card>
            <CardHeader>
